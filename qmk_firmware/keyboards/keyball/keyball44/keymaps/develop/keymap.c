...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_universal(
    ...
    KC_INT5   , KC_Z     , 	SFT_T(KC_X)  , LT(3,KC_C) , LT(1,KC_V)     , KC_B     ,                                        KC_N     , LT(1,KC_M)     , LT(3,KC_COMM)  , 	SFT_T(KC_DOT)   , KC_SLSH  , KC_DEL  ,
              TO(2), _______ , _______          , KC_SPC,        KC_ENT,                  KC_LWIN,   KC_TAB, 	KC_ESC,     KC_MINS  , S(KC_MINS)
  ),
  ...
  [2] = LAYOUT_universal(
    ...
    TO(0)  ,S(KC_SCLN), KC_4     , KC_5    , KC_6     , KC_RBRC  ,                                         KC_NUHS  , KC_MINS  , S(KC_EQL), S(KC_3)  , KC_QUOT  , S(KC_2)  ,
  ...
  [3] = LAYOUT_universal(
    ...
    TO(0)  , RGB_HUI  , RGB_SAI  , RGB_VAI  , _______  , SCRL_DVI ,                                        RGB_M_X  , RGB_M_G  , RGB_M_T  , RGB_M_TW , _______  , _______  ,
